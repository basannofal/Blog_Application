              ...
              <section>
                <div class="dash-content">
                  ...
                  <div class="activity">
                    ...
                    <p class="mb-3" style={{ fontSize: 20, fontWeight: "bold" }}>All Published Blog Post </p>
                    ...
                    <div className="d-flex" style={{ fontSize: "14px" }}>
                      ...
                      <p className="mx-2">|</p>
                      <p className="text-dark" >Published ({pb})</p>
...
export default AllPublishedBlogPost;